...
- **Heavy ONNX models** (e.g. >= 100MB) must be exported with page-aligned external data (using `scripts/export_external_data.py`) to enable zero-copy memory mapping and minimize peak RSS.
